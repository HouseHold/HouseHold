...
final class Version20200112000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stock_inventory_event (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', `index` INT NOT NULL, recorded DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_micro)\', type VARCHAR(255) NOT NULL, payload LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', metadata LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id, `index`)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
